...
namespace EW.Framework
{
    ...
    internal partial class GL
    {
        ...
        [System.Security.SuppressUnmanagedCodeSecurity()]
        [MonoNativeFunctionWrapper]
        internal delegate void GetActiveUniformDelegate(int program, int index, int bufSize,
            out int length, out int size, out int type, StringBuilder name);
        internal static GetActiveUniformDelegate GetActiveUniform;
        ...
        internal unsafe delegate void ShaderSourceDelegate2(int shaderId, int count, string[] str, IntPtr length);
        internal static ShaderSourceDelegate2 ShaderSource2;
        ...
        [System.Security.SuppressUnmanagedCodeSecurity()]
        [MonoNativeFunctionWrapper]
        internal delegate void BindAttribLocationDelegate(int programId, int index, string name);
        internal static BindAttribLocationDelegate BindAttribLocation;
        ...
        internal static BlendEquationDelegate BlendEquation;
        ...
        [System.Security.SuppressUnmanagedCodeSecurity()]
        [MonoNativeFunctionWrapper]
        internal delegate void BlendFuncDelegate(int sfactor, int dfactor);
        ...
        internal static void LoadEntryPoints ()
        {
            ...
            GetActiveUniform = (GetActiveUniformDelegate)LoadEntryPoint<GetActiveUniformDelegate>("glGetActiveUniform");
            ...
            ShaderSource2 = (ShaderSourceDelegate2)LoadEntryPoint<ShaderSourceDelegate2>("glShaderSource");
            ...
            BindAttribLocation = (BindAttribLocationDelegate)LoadEntryPoint<BindAttribLocationDelegate>("glBindAttribLocation");
            ...
            BlendEquation = (BlendEquationDelegate)LoadEntryPoint<BlendEquationDelegate>("glBlendEquation");
            ...
            BlendFunc = (BlendFuncDelegate)LoadEntryPoint<BlendFuncDelegate>("glBlendFunc");
