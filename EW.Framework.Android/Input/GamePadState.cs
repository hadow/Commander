    ...
    public partial struct GamePadState
    {
        ...
        private Buttons GetVirtualButtons ()
        {
            ...
            if (DPad.Down == ButtonState.Pressed)
                result |= EW.Framework.Input.Buttons.DPadDown;
            if (DPad.Up == ButtonState.Pressed)
                result |= EW.Framework.Input.Buttons.DPadUp;
            if (DPad.Left == ButtonState.Pressed)
                result |= EW.Framework.Input.Buttons.DPadLeft;
            if (DPad.Right == ButtonState.Pressed)
                result |= EW.Framework.Input.Buttons.DPadRight;
