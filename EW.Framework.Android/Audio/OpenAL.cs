...
namespace EW.Framework.Audio
{
    ...
    internal class AL
    {
        ...
        [DllImport(NativeLibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "alSourceRewind")]
        internal static extern void SourceRewind(uint source);

        [DllImport(NativeLibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "alSourcei")]
        internal static extern void Sourcei(uint source, int param, int value);
        ...
        [CLSCompliant(false)]
        [DllImport(NativeLibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "alListenerf")]
        internal static extern void Listenerf(ALSourcef param, float value);

        [CLSCompliant(false)]
        [DllImport(NativeLibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "alListenerfv")]
        internal static extern void Listenerfv(int param, float[] values);

        [CLSCompliant(false)]
        [DllImport(NativeLibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "alListener3f")]
