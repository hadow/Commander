...
namespace EW.Mods.Common.Traits
{
    ...
    public class TunnelEntrance:INotifyCreated
    {
        ...
        void INotifyCreated.Created(Actor self){
            ...
            var tunnel = self.World.WorldActor.Info.TraitInfos<TerrainTunnelInfo>().FirstOrDefault(tti => tti.PortalCells().Contains(sensor));
            ...
            if(tunnel != null){
                ...
                self.World.AddFrameEndTask(w =>
                {
                    ...
                    var other = self.World.ActorsWithTrait<TunnelEntrance>().FirstOrDefault(x => x.Actor != self && portalCells.Contains(x.Actor.Location + x.Trait.info.Sensor));
